...
function getLocalStorePkgs(folder, localstoreDb) {
...
function getDirectory(serverConfig, localstoreDb) {
  return getLocalStorePkgs(serverConfig.packagesFolder, localstoreDb);
}
