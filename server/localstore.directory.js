...
function getLocalStorePkgs(ip, folder, localstoreDb) {
    ...
    return fs_1.default
        ...
        .filter(function (file) { return lsFileRegexp.test(file); })
        .map(function (file) {
        var _a = file.match(lsFileRegexp), result = _a[0], name = _a[1], region = _a[2], type = _a[3], contentId = _a[4], productCodeName = _a[5], productCode = _a[6], productDetailName = _a[7], rap = _a[8];
